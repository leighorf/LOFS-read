...
inline void calc_pgrad_u(float *pipert, float *thrhopert, float *qv0, float *th0, float *pgradu, \
...
inline void calc_pgrad_v(float *pipert, float *thrhopert, float *qv0, float *th0, float *pgradv, \
...
/* Compute the pressure gradient forcing for
   the W momentum equation */
inline void calc_pgrad_w(float *pipert, float *thrhopert, float *qv0, float *th0, float *pgradw, \
...
/* Compute the buoyancy forcing
   the W momentum equation */
inline void calc_buoyancy(float *thrhopert, float *th0, float *buoy, int i, int j, int k, int nx, int ny) {
